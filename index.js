...
const donet = "https://linktr.ee/technicalsushant";
const owner = ["12195250745"];
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Bot success conneted to server", "yellow"));
      console.log(color("Type menu to see menu"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Bot started!\n\nDon't forget to support, Technical Sushant:)\n${donet}` });
    }
